...
# Derives the closest loan term from the initial value (int) by comparing the absolute differences 
# between the initial value and the loan terms (thirty year fixed, twenty year fixed, fifteen year fixed)
